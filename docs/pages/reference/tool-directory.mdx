...
| `meeting-scheduler` | Governed Google Calendar and Zoom booking, reconciliation, recording, and summary retrieval | `GOOGLE_TOKEN_JSON`, `ZOOM_ACCESS_TOKEN`, `CENTAUR_POSTGRES_DSN` |
...
| `meeting-scheduler` | Governed Calendar/Zoom booking and post-meeting artifact retrieval | `GOOGLE_TOKEN_JSON`, `ZOOM_ACCESS_TOKEN`, `CENTAUR_POSTGRES_DSN` |
