...
| `meeting-scheduler` | Find free/busy slots and govern one Calendar + World Foundation Zoom meeting per occurrence | `GOOGLE_TOKEN_JSON`, `ZOOM_ACCESS_TOKEN`, `CENTAUR_POSTGRES_DSN` |
...
| `meeting-scheduler` | Free/busy availability plus governed Calendar/Zoom booking, rescheduling, cancellation, and reconciliation | `GOOGLE_TOKEN_JSON`, `ZOOM_ACCESS_TOKEN`, `CENTAUR_POSTGRES_DSN` |
